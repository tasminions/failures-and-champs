...
function getFAC6Members(token,cb){
  return getMembers('fac6',token,cb);
}

function getDwylMembers(token, cb){
  return getMembers('dwyl',token,cb);
}
...
module.exports = {
  ...
  getFAC6Members: getFAC6Members,
  getDwylMembers: getDwylMembers
};
